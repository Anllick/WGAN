...
## train set location
config.TRAIN.hr_img_path = 'Data/train/HR/'
config.TRAIN.lr_img_path = 'Data/train/LR/'
...
config.VALID = edict()
## test set location
config.VALID.hr_img_path = 'Data/train/HR/'
config.VALID.lr_img_path = 'Data/train/LR/'
#config.VALID.hr_img_path = 'data2017/DIV2K_valid_HR/'
#config.VALID.lr_img_path = 'data2017/DIV2K_valid_LR_bicubic/X4/'

config.VALID.logdir = './log/'#'/home/ubuntu/SRGAN_Wasserstein/log/'
